exports.seed = function(knex, Promise) {
  return knex('comments').del()
    .then(() => {
      return Promise.all([
        knex('comments').insert({id: 50000001, comment: '', user_id: 10000001, url_id: 20000001, date:''}),
        knex('comments').insert({id: 50000002, comment: '', user_id: 10000002, url_id: 20000002, date:''}),
        ...
        knex('comments').insert({id: 50000004, comment: '', user_id: 10000001, url_id: 20000004, date:''}),
        knex('comments').insert({id: 50000005, comment: '', user_id: 10000002, url_id: 20000005, date:''}),
